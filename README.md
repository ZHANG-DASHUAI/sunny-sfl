...
- 当前已确认配置伴奏的歌曲包括：晴天、爱你没差、手写的从前、夜曲、发如雪、半岛铁盒、等你下课、说好不哭、大笨钟、彩虹、听妈妈的话。Mojito 的标准伴奏地址当前返回 404，因此仍保持未填写。

「爱你没差」统一使用 id `ai-ni-mei-cha`，三个 R2 文件名均为 `ai-ni-mei-cha.mp3`，不要使用其他旧拼写。
