import { getAdminSummary, json } from "../../_shared/stats.js";
...
export async function onRequestGet(context) {
  ...
  try {
    return json(await getAdminSummary(context.env.STATS_KV));
  } catch (error) {
    console.error("Admin summary failed:", error);
    return json({ ok: false, error: "Admin summary failed" }, 500);
  }
}
