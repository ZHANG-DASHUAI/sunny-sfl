...
const songs = [
  ...
  createSong(
    ...
    "听妈妈的话",
    ["想被安静陪着", "想放空一下"],
    AUDIO_NORMAL_BASE_URL + "ting-ma-ma-de-hua.mp3",
    "适合想回到简单一点的状态，被温柔提醒一下。",
    {
      lyricsTimed: [
        { time: 0, text: "听妈妈的话 - 周杰伦 (Jay Chou)" },
        { time: 10, text: "小朋友 你是否有很多问号" },
        { time: 12, text: "为什么 别人在那看漫画" },
        { time: 15, text: "我却在学画画 对着钢琴说话" },
        { time: 17, text: "别人在玩游戏" },
        { time: 18, text: "我却靠在墙壁背我的 ABC" },
        { time: 21, text: "我说我要一台大大的飞机" },
        { time: 23, text: "但却得到一台旧旧录音机" },
        { time: 26, text: "为什么要听妈妈的话" },
        { time: 28, text: "长大后你就会开始懂了这段话" },
        { time: 30, text: "哼" },
        { time: 31, text: "长大后我开始明白" },
        { time: 33, text: "为什么我 跑得比别人快" },
        { time: 35, text: "飞得比别人高" },
        { time: 36, text: "将来大家看的都是我画的漫画" },
        { time: 38, text: "大家唱的都是 我写的歌" },
        { time: 41, text: "妈妈的辛苦 不让你看见" },
        { time: 44, text: "温暖的食谱在她心里面" },
        { time: 46, text: "有空就多多握握她的手" },
        { time: 49, text: "把手牵着一起梦游" },
        { time: 51, text: "听妈妈的话 别让她受伤" },
        { time: 62, text: "想快快长大 才能保护她" },
        { time: 72, text: "美丽的白发 幸福中发芽" },
        { time: 82, text: "天使的魔法 温暖中慈祥" },
        { time: 92, text: "在你的未来" },
        { time: 93, text: "音乐是你的王牌" },
        { time: 94, text: "拿王牌谈个恋爱" },
        { time: 96, text: "唉 我不想把你教坏" },
        { time: 97, text: "还是听妈妈的话吧" },
        { time: 99, text: "晚点再恋爱吧" },
        { time: 100, text: "我知道你未来的路" },
        { time: 102, text: "但妈比我更清楚" },
        { time: 103, text: "你会开始学其他同学" },
        { time: 105, text: "在书包写东写西" },
        { time: 106, text: "但我建议最好写妈妈" },
        { time: 107, text: "我会用功读书" },
        { time: 108, text: "用功读书" },
        { time: 109, text: "怎么会从我嘴巴说出" },
        { time: 111, text: "不想你输" },
        { time: 112, text: "所以要叫你用功读书" },
        { time: 113, text: "妈妈织给你的毛衣" },
        { time: 114, text: "你要好好的收着" },
        { time: 116, text: "因为母亲节到的时候" },
        { time: 117, text: "我要告诉她我还留着" },
        { time: 118, text: "对了 我会遇到了周润发" },
        { time: 120, text: "所以你可以跟同学炫耀" },
        { time: 121, text: "赌神未来是你爸爸" },
        { time: 123, text: "我找不到 童年写的情书" },
        { time: 125, text: "你写完不要送人" },
        { time: 126, text: "因为过两天你会在操场上捡到" },
        { time: 129, text: "你会开始喜欢上流行歌" },
        { time: 131, text: "因为张学友开始准备唱吻别" },
        { time: 134, text: "听妈妈的话 别让她受伤" },
        { time: 144, text: "想快快长大 才能保护她" },
        { time: 155, text: "美丽的白发 幸福中发芽" },
        { time: 165, text: "天使的魔法 温暖中慈祥" },
        { time: 175, text: "听妈妈的话 别让她受伤" },
        { time: 185, text: "想快快长大 才能保护她" },
        { time: 196, text: "长大后我开始明白" },
        { time: 198, text: "为什么我 跑得比别人快" },
        { time: 200, text: "飞得比别人高" },
        { time: 201, text: "将来大家看的都是我画的漫画" },
        { time: 204, text: "大家唱的都是 我写的歌" },
        { time: 206, text: "妈妈的辛苦 不让你看见" },
        { time: 209, text: "温暖的食谱在她心里面" },
        { time: 212, text: "有空就多多握握她的手" },
        { time: 214, text: "把手牵着一起梦游" },
        { time: 217, text: "听妈妈的话 别让她受伤" },
        { time: 227, text: "想快快长大 才能保护她" },
        { time: 237, text: "美丽的白发 幸福中发芽" },
        { time: 247, text: "天使的魔法 温暖中慈祥" }
      ]
    }
  ),
  createSong(
    ...
    "爱在西元前",
    ["想回到从前", "想被安静陪着"],
    AUDIO_NORMAL_BASE_URL + "ai-zai-xi-yuan-qian.mp3",
    "适合把故事慢慢翻开，像听一段很远很远的浪漫。",
    {
      lyricsTimed: [
        { time: 0, text: "爱在西元前 - 周杰伦 (Jay Chou)" },
        { time: 31, text: "古巴比伦王颁布了" },
        { time: 33, text: "汉摩拉比法典" },
        { time: 35, text: "刻在黑色的玄武岩" },
        { time: 37, text: "距今已经三千七百多年" },
        { time: 39, text: "你在橱窗前" },
        { time: 40, text: "凝视碑文的字眼" },
        { time: 43, text: "我却在旁静静欣赏" },
        { time: 44, text: "你那张我深爱的脸" },
        { time: 47, text: "祭司神殿征战" },
        { time: 49, text: "弓箭是谁的从前" },
        { time: 51, text: "喜欢在人潮中" },
        { time: 52, text: "你只属于我的那画面" },
        { time: 54, text: "经过苏美女神身边" },
        { time: 56, text: "我以女神之名许愿" },
        { time: 58, text: "思念像底格里斯河般的漫延" },
        { time: 62, text: "当古文明只剩下难解的语言" },
        { time: 69, text: "传说就成了永垂不朽的诗篇" },
        { time: 77, text: "我给你的爱写在西元前" },
        { time: 80, text: "深埋在美索不达米亚平原" },
        { time: 85, text: "几十个世纪后出土发现" },
        { time: 88, text: "泥板上的字迹依然清晰可见" },
        { time: 93, text: "我给你的爱写在西元前" },
        { time: 95, text: "深埋在美索不达米亚平原" },
        { time: 100, text: "用楔形文字刻下了永远" },
        { time: 103, text: "那已风化千年的誓言" },
        { time: 106, text: "一切又重演" },
        { time: 111, text: "祭司神殿征战" },
        { time: 112, text: "弓箭是谁的从前" },
        { time: 115, text: "喜欢在人潮中" },
        { time: 116, text: "你只属于我的那画面" },
        { time: 119, text: "经过苏美女神身边" },
        { time: 120, text: "我以女神之名许愿" },
        { time: 123, text: "思念像底格里斯河般的漫延" },
        { time: 127, text: "当古文明只剩下难解的语言" },
        { time: 133, text: "传说就成了永垂不朽的诗篇" },
        { time: 142, text: "我给你的爱写在西元前" },
        { time: 144, text: "深埋在美索不达米亚平原" },
        { time: 149, text: "几十个世纪后出土发现" },
        { time: 152, text: "泥板上的字迹依然清晰可见" },
        { time: 157, text: "我给你的爱写在西元前" },
        { time: 160, text: "深埋在美索不达米亚平原" },
        { time: 165, text: "用楔形文字刻下了永远" },
        { time: 167, text: "那已风化千年的誓言" },
        { time: 171, text: "一切又重演" },
        { time: 172, text: "我感到很疲倦离家乡还是很远" },
        { time: 178, text: "害怕再也不能回到你身边" },
        { time: 187, text: "我给你的爱写在西元前" },
        { time: 190, text: "深埋在美索不达米亚平原" },
        { time: 195, text: "几十个世纪后出土发现" },
        { time: 197, text: "泥板上的字迹依然清晰可见" },
        { time: 202, text: "我给你的爱写在西元前" },
        { time: 205, text: "深埋在美索不达米亚平原" },
        { time: 210, text: "用楔形文字刻下了永远" },
        { time: 212, text: "那已风化千年的誓言" },
        { time: 216, text: "一切又重演" },
        { time: 217, text: "爱在西元前" },
        { time: 224, text: "爱在西元前" }
      ]
  ...
  createSong(
    ...
    "不该",
    ["有点 emo", "想被安静陪着"],
    AUDIO_NORMAL_BASE_URL + "bu-gai.mp3",
    "适合有点遗憾的时候听，像把没说完的话轻轻放下。",
    {
      lyricsTimed: [
        { time: 0, text: "不该 (with aMEI) - 周杰伦 (Jay Chou)/张惠妹 (aMEI)" },
        { time: 21, text: "Jay：" },
        { time: 26, text: "假装我们还在一块" },
        { time: 33, text: "我真的演不出来" },
        { time: 39, text: "还是不习惯你不在" },
        { time: 44, text: "这身份转变太快" },
        { time: 49, text: "aMEI：" },
        { time: 51, text: "画面里不需要旁白" },
        { time: 58, text: "却谁都看的出来" },
        { time: 65, text: "是我情绪涌了上来" },
        { time: 70, text: "想哭却一遍空白" },
        { time: 75, text: "Jay：" },
        { time: 76, text: "雪地里相爱" },
        { time: 78, text: "他们说零下已结晶的誓言不会坏" },
        { time: 82, text: "合：" },
        { time: 83, text: "但爱的状态" },
        { time: 84, text: "却不会永远都冰封" },
        { time: 86, text: "而透明的存在" },
        { time: 88, text: "合：" },
        { time: 89, text: "轻轻飘 落下来" },
        { time: 92, text: "许下的梦 融化的太快" },
        { time: 96, text: "或许我们都不该醒来" },
        { time: 100, text: "aMEI：" },
        { time: 101, text: "你还是住在我的回忆里不出来" },
        { time: 107, text: "Jay：" },
        { time: 108, text: "让我们微笑离开让故事留下来" },
        { time: 113, text: "合：" },
        { time: 114, text: "放手后爱依然在" },
        { time: 117, text: "雪融了就应该花开" },
        { time: 121, text: "缘若尽了" },
        { time: 123, text: "就不该再重来" },
        { time: 126, text: "aMEI：" },
        { time: 127, text: "你依旧住在我的回忆里不出来" },
        { time: 133, text: "Jay：" },
        { time: 133, text: "我离开将你的手交给下个最爱" },
        { time: 139, text: "aMEI：" },
        { time: 139, text: "纠缠与" },
        { time: 140, text: "合：" },
        { time: 141, text: "Oh 固执等待" },
        { time: 143, text: "反而是另一种伤害" },
        { time: 147, text: "彼此紧握的手松开" },
        { time: 150, text: "去拥抱更多未来" },
        { time: 165, text: "Jay：" },
        { time: 167, text: "错过的时间怎么买" },
        { time: 173, text: "谁都付不出来" },
        { time: 177, text: "aMEI：" },
        { time: 180, text: "或许我们学会释怀" },
        { time: 185, text: "让过去安静下来" },
        { time: 191, text: "合：" },
        { time: 192, text: "雪地里相爱" },
        { time: 193, text: "他们说零下已结晶的誓言不会坏" },
        { time: 198, text: "但爱的状态" },
        { time: 199, text: "却不会永远都冰封" },
        { time: 202, text: "而透明的存在" },
        { time: 203, text: "合：" },
        { time: 204, text: "轻轻飘 落下来" },
        { time: 207, text: "许下的梦融化的太快" },
        { time: 211, text: "或许我们都不该醒来" },
        { time: 216, text: "aMEI：" },
        { time: 216, text: "你还是住在我的回忆里不出来" },
        { time: 222, text: "Jay：" },
        { time: 223, text: "让我们微笑离开让故事留下来" },
        { time: 229, text: "合：" },
        { time: 229, text: "放手后爱依然在" },
        { time: 232, text: "雪融了就应该花开" },
        { time: 236, text: "缘若尽了" },
        { time: 238, text: "就不该再重来" },
        { time: 241, text: "aMEI：" },
        { time: 242, text: "你依旧住在我的回忆里不出来" },
        { time: 248, text: "Jay：" },
        { time: 248, text: "我离开将你的手交给下个" },
        { time: 252, text: "合：" },
        { time: 253, text: "最爱" },
        { time: 255, text: "aMEI：" },
        { time: 255, text: "纠缠与" },
        { time: 256, text: "合：" },
        { time: 256, text: "Oh固执等待" },
        { time: 258, text: "反而是另一种伤害" },
        { time: 262, text: "彼此紧握的手松开" },
        { time: 266, text: "去拥抱更多未来" }
      ]
    }
  ),
  createSong(
    ...
    "不能说的秘密",
    ["想回到从前", "想被安静陪着"],
    AUDIO_NORMAL_BASE_URL + "bu-neng-shuo-de-mi-mi.mp3",
    "适合藏一点心事的时候听，不用解释，旋律会懂。",
    {
      lyricsTimed: [
        { time: 0, text: "不能说的秘密 - 周杰伦 (Jay Chou)" },
        { time: 13, text: "冷咖啡离开了杯垫" },
        { time: 17, text: "我忍住的情绪在很后面" },
        { time: 27, text: "拼命想挽回的从前" },
        { time: 30, text: "在我脸上依旧清晰可见" },
        { time: 40, text: "最美的不是下雨天" },
        { time: 43, text: "是曾与你躲过雨的屋檐" },
        { time: 52, text: "回忆的画面 在荡着秋千" },
        { time: 59, text: "梦开始不甜" },
        { time: 65, text: "你说把爱渐渐放下会走更远" },
        { time: 71, text: "又何必去改变 已错过的时间" },
        { time: 78, text: "你用你的指尖阻止我说再见" },
        { time: 84, text: "想象你在身边 在完全失去之前" },
        { time: 91, text: "你说把爱渐渐放下会走更远" },
        { time: 98, text: "或许命运的签 只让我们遇见" },
        { time: 105, text: "只让我们相恋这一季的秋天" },
        { time: 111, text: "飘落后才发现 这幸福的碎片" },
        { time: 118, text: "要我怎么捡" },
        { time: 147, text: "冷咖啡离开了杯垫" },
        { time: 150, text: "我忍住的情绪在很后面" },
        { time: 160, text: "拼命想挽回的从前" },
        { time: 163, text: "在我脸上依旧清晰可见" },
        { time: 173, text: "最美的不是下雨天" },
        { time: 177, text: "是曾与你躲过雨的屋檐" },
        { time: 186, text: "回忆的画面 在荡着秋千" },
        { time: 192, text: "梦开始不甜" },
        { time: 198, text: "你说把爱渐渐放下会走更远" },
        { time: 205, text: "又何必去改变 已错过的时间" },
        { time: 211, text: "你用你的指尖阻止我说再见" },
        { time: 218, text: "想象你在身边 在完全失去之前" },
        { time: 225, text: "你说把爱渐渐放下会走更远" },
        { time: 231, text: "或许命运的签 只让我们遇见" },
        { time: 238, text: "只让我们相恋这一季的秋天" },
        { time: 245, text: "飘落后才发现 这幸福的碎片" },
        { time: 251, text: "要我怎么捡" }
      ]
    }
  ),
  createSong(
    ...
    "稻香",
    ["想放空一下", "想被安静陪着"],
    AUDIO_NORMAL_BASE_URL + "dao-xiang.mp3",
    "适合想被轻轻拉一把的时候，慢慢找回一点力气。",
    {
      lyricsTimed: [
        { time: 0, text: "稻香 - 周杰伦 (Jay Chou)" },
        { time: 30, text: "对这个世界如果你有太多的抱怨" },
        { time: 34, text: "跌倒了就不敢继续往前走" },
        { time: 37, text: "为什么人要这么的脆弱堕落" },
        { time: 41, text: "请你打开电视看看" },
        { time: 43, text: "多少人为生命在努力勇敢的走下去" },
        { time: 47, text: "我们是不是该知足" },
        { time: 49, text: "珍惜一切就算没有拥有" },
        { time: 53, text: "还记得你说家是唯一的城堡" },
        { time: 57, text: "随着稻香河流继续奔跑" },
        { time: 60, text: "微微笑 小时候的梦我知道" },
        { time: 65, text: "不要哭让萤火虫带着你逃跑" },
        { time: 69, text: "乡间的歌谣永远的依靠" },
        { time: 72, text: "回家吧 回到最初的美好" },
        { time: 101, text: "不要这么容易就想放弃" },
        { time: 103, text: "就像我说的" },
        { time: 104, text: "追不到的梦想换个梦不就得了" },
        { time: 107, text: "为自己的人生鲜艳上色" },
        { time: 109, text: "先把爱涂上喜欢的颜色" },
        { time: 112, text: "笑一个吧" },
        { time: 113, text: "功成名就不是目的" },
        { time: 115, text: "让自己快乐快乐这才叫做意义" },
        { time: 118, text: "童年的纸飞机" },
        { time: 120, text: "现在终于飞回我手里" },
        { time: 124, text: "所谓的那快乐" },
        { time: 125, text: "赤脚在田里追蜻蜓追到累了" },
        { time: 128, text: "偷摘水果被蜜蜂给叮到怕了" },
        { time: 131, text: "谁在偷笑呢" },
        { time: 133, text: "我靠着稻草人" },
        { time: 134, text: "吹着风 唱着歌 睡着了" },
        { time: 137, text: "午后吉他在虫鸣中更清脆" },
        { time: 140, text: "阳光洒在路上就不怕心碎" },
        { time: 143, text: "珍惜一切 就算没有拥有" },
        { time: 147, text: "还记得你说家是唯一的城堡" },
        { time: 151, text: "随着稻香河流继续奔跑" },
        { time: 154, text: "微微笑 小时候的梦我知道" },
        { time: 159, text: "不要哭让萤火虫带着你逃跑" },
        { time: 163, text: "乡间的歌谣永远的依靠" },
        { time: 166, text: "回家吧 回到最初的美好" },
        { time: 171, text: "还记得你说家是唯一的城堡" },
        { time: 174, text: "随着稻香河流继续奔跑" },
        { time: 177, text: "微微笑 小时候的梦我知道" },
        { time: 182, text: "不要哭让萤火虫带着你逃跑" },
        { time: 186, text: "乡间的歌谣永远的依靠" },
        { time: 189, text: "回家吧 回到最初的美好" }
      ]
    }
  ),
  createSong(
    ...
    "东风破",
    ["想被安静陪着", "想回到从前"],
    AUDIO_NORMAL_BASE_URL + "dong-feng-po.mp3",
    "适合安静一点的时刻，像风吹过旧院子。",
    {
      lyricsTimed: [
        { time: 0, text: "东风破 - 周杰伦 (Jay Chou)" },
        { time: 14, text: "一盏离愁 孤单伫立在窗口" },
        { time: 20, text: "我在门后 假装你人还没走" },
        { time: 27, text: "旧地如重游 月圆更寂寞" },
        { time: 33, text: "夜半清醒的烛火 不忍苛责我" },
        { time: 40, text: "一壶漂泊 浪迹天涯难入喉" },
        { time: 47, text: "你走之后 酒暖回忆思念瘦" },
        { time: 53, text: "水向东流 时间怎么偷" },
        { time: 60, text: "花开就一次成熟 我却错过" },
        { time: 70, text: "谁在用琵琶弹奏 一曲东风破" },
        { time: 76, text: "岁月在墙上剥落 看见小时候" },
        { time: 83, text: "犹记得那年我们都还很年幼" },
        { time: 89, text: "而如今琴声幽幽 我的等候 你没听过" },
        { time: 96, text: "谁在用琵琶弹奏 一曲东风破" },
        { time: 102, text: "枫叶将故事染色 结局我看透" },
        { time: 109, text: "篱笆外的古道我牵着你走过" },
        { time: 116, text: "荒烟蔓草的年头 就连分手都很沉默" },
        { time: 148, text: "一壶漂泊 浪迹天涯难入喉" },
        { time: 155, text: "你走之后 酒暖回忆思念瘦" },
        { time: 162, text: "水向东流 时间怎么偷" },
        { time: 168, text: "花开就一次成熟 我却错过" },
        { time: 178, text: "谁在用琵琶弹奏 一曲东风破" },
        { time: 185, text: "岁月在墙上剥落 看见小时候" },
        { time: 191, text: "犹记得那年我们都还很年幼" },
        { time: 198, text: "而如今琴声幽幽 我的等候 你没听过" },
        { time: 204, text: "谁在用琵琶弹奏 一曲东风破" },
        { time: 211, text: "枫叶将故事染色 结局我看透" },
        { time: 217, text: "篱笆外的古道我牵着你走过" },
        { time: 224, text: "荒烟蔓草的年头 就连分手都" },
        { time: 231, text: "谁在用琵琶弹奏 一曲东风破" },
        { time: 237, text: "岁月在墙上剥落 看见小时候" },
        { time: 244, text: "犹记得那年我们都还很年幼" },
        { time: 250, text: "而如今琴声幽幽 我的等候 你没听过" },
        { time: 257, text: "谁在用琵琶弹奏 一曲东风破" },
        { time: 263, text: "枫叶将故事染色 结局我看透" },
        { time: 270, text: "篱笆外的古道我牵着你走过" },
        { time: 277, text: "荒烟蔓草的年头 就连分手都很沉默" }
      ]
    }
  ),
  createSong(
    ...
    "反方向的钟",
    ["有点 emo", "想回到从前"],
    AUDIO_NORMAL_BASE_URL + "fan-fang-xiang-de-zhong.mp3",
    "适合想把时间倒回一点点的时候，哪怕只是在歌里。",
    {
      lyricsTimed: [
        { time: 0, text: "反方向的钟 - 周杰伦 (Jay Chou)" },
        { time: 45, text: "迷迷蒙蒙 你给的梦" },
        { time: 48, text: "出现裂缝 隐隐作痛" },
        { time: 50, text: "怎么沟通你都没空" },
        { time: 53, text: "说我不懂 说了没用" },
        { time: 55, text: "他的笑容 有何不同" },
        { time: 58, text: "在你心中 我不再受宠" },
        { time: 61, text: "我的天空 是雨是风 还是彩虹" },
        { time: 64, text: "你在操纵" },
        { time: 66, text: "恨自己真的没用情绪激动" },
        { time: 71, text: "一颗心到现在还在抽痛" },
        { time: 76, text: "还为分手前那句抱歉在感动" },
        { time: 86, text: "穿梭时间的画面的钟" },
        { time: 91, text: "从反方向 开始移动" },
        { time: 96, text: "回到当初爱你的时空" },
        { time: 101, text: "停格内容 不忠" },
        { time: 106, text: "所有回忆对着我进攻" },
        { time: 112, text: "我的伤口 被你拆封" },
        { time: 117, text: "誓言太沉重泪被纵容" },
        { time: 122, text: "脸上汹涌 失控" },
        { time: 137, text: "城市霓虹 不安跳动" },
        { time: 138, text: "染红夜空 过去种种" },
        { time: 140, text: "像一场梦 不敢去碰" },
        { time: 141, text: "一想就痛 心碎内容" },
        { time: 142, text: "每一秒钟 都有不同" },
        { time: 144, text: "你不懂 连一句珍重" },
        { time: 145, text: "也有苦衷 也不想送" },
        { time: 147, text: "寒风中 废墟烟囱" },
        { time: 148, text: "停止转动 一切落空" },
        { time: 149, text: "在人海中盲目跟从" },
        { time: 151, text: "别人的梦 全面放纵" },
        { time: 152, text: "恨没有用 疗伤止痛" },
        { time: 153, text: "不再感动 没有梦" },
        { time: 155, text: "痛不知轻重" },
        { time: 155, text: "泪水鲜红 全面放纵" },
        { time: 168, text: "恨自己真的没用情绪激动" },
        { time: 173, text: "一颗心到现在还在抽痛" },
        { time: 178, text: "还为分手前那句抱歉在感动" },
        { time: 188, text: "穿梭时间的画面的钟" },
        { time: 193, text: "从反方向 开始移动" },
        { time: 198, text: "回到当初爱你的时空" },
        { time: 203, text: "停格内容 不忠" },
        { time: 208, text: "所有回忆对着我进攻" },
        { time: 213, text: "我的伤口 被你拆封" },
        { time: 218, text: "誓言太沉重泪被纵容" },
        { time: 223, text: "脸上汹涌 失控" },
        { time: 228, text: "穿梭时间的画面的钟" },
        { time: 233, text: "从反方向 开始移动" },
        { time: 238, text: "回到当初爱你的时空" },
        { time: 243, text: "停格内容 不忠" },
        { time: 249, text: "所有回忆对着我进攻" }
      ]
    }
  ),
  createSong(
  ...
  createSong(
    ...
    "告白气球",
    ["想听甜一点", "想放空一下"],
    AUDIO_NORMAL_BASE_URL + "gao-bai-qi-qiu.mp3",
    "适合甜一点的心情，像空气里飘着一点点糖。",
    {
      lyricsTimed: [
        { time: 0, text: "告白气球 - 周杰伦 (Jay Chou)" },
        { time: 23, text: "塞纳河畔 左岸的咖啡" },
        { time: 26, text: "我手一杯 品尝你的美" },
        { time: 29, text: "留下唇印的嘴" },
        { time: 34, text: "花店玫瑰 名字写错谁" },
        { time: 36, text: "告白气球 风吹到对街" },
        { time: 40, text: "微笑在天上飞" },
        { time: 44, text: "你说你有点难追" },
        { time: 46, text: "想让我知难而退" },
        { time: 49, text: "礼物不需挑最贵" },
        { time: 51, text: "只要香榭的落叶" },
        { time: 54, text: "喔 营造浪漫的约会" },
        { time: 57, text: "不害怕搞砸一切" },
        { time: 59, text: "拥有你就拥有全世界" },
        { time: 65, text: "亲爱的 爱上你" },
        { time: 68, text: "从那天起" },
        { time: 71, text: "甜蜜的很轻易" },
        { time: 75, text: "亲爱的 别任性" },
        { time: 78, text: "你的眼睛" },
        { time: 81, text: "在说我愿意" },
        { time: 108, text: "塞纳河畔 左岸的咖啡" },
        { time: 111, text: "我手一杯 品尝你的美" },
        { time: 114, text: "留下唇印的嘴" },
        { time: 119, text: "花店玫瑰 名字写错谁" },
        { time: 122, text: "告白气球 风吹到对街" },
        { time: 125, text: "微笑在天上飞" },
        { time: 129, text: "你说你有点难追" },
        { time: 131, text: "想让我知难而退" },
        { time: 134, text: "礼物不需挑最贵" },
        { time: 137, text: "只要香榭的落叶" },
        { time: 139, text: "喔 营造浪漫的约会" },
        { time: 142, text: "不害怕搞砸一切" },
        { time: 145, text: "拥有你就拥有 全世界" },
        { time: 150, text: "亲爱的 爱上你" },
        { time: 153, text: "从那天起" },
        { time: 156, text: "甜蜜的很轻易" },
        { time: 160, text: "亲爱的 别任性" },
        { time: 164, text: "你的眼睛" },
        { time: 167, text: "在说我愿意" },
        { time: 171, text: "亲爱的 爱上你" },
        { time: 175, text: "恋爱日记" },
        { time: 177, text: "飘香水的回忆" },
        { time: 182, text: "一整瓶 的梦境" },
        { time: 185, text: "全都有你" },
        { time: 188, text: "搅拌在一起" },
        { time: 193, text: "亲爱的别任性" },
        { time: 196, text: "你的眼睛" },
        { time: 201, text: "在说我愿意" }
      ]
    }
  ...
  createSong(
    ...
    "搁浅",
    ["有点 emo", "想被安静陪着"],
    AUDIO_NORMAL_BASE_URL + "ge-qian.mp3",
    "适合情绪停在半路的时候，不急着往前，也不急着回头。",
    {
      lyricsTimed: [
        { time: 0, text: "搁浅 - 周杰伦 (Jay Chou)" },
        { time: 16, text: "久未放晴的天空" },
        { time: 20, text: "依旧留着你的笑容" },
        { time: 24, text: "哭过却无法掩埋歉疚" },
        { time: 31, text: "风筝在阴天搁浅" },
        { time: 35, text: "想念还在等待救援" },
        { time: 40, text: "我拉着线复习你给的温柔" },
        { time: 46, text: "曝晒在一旁的寂寞" },
        { time: 50, text: "笑我给不起承诺" },
        { time: 53, text: "怎么会怎么会你竟原谅了我" },
        { time: 61, text: "我只能永远读着对白" },
        { time: 65, text: "读着我给你的伤害" },
        { time: 69, text: "我原谅不了我" },
        { time: 72, text: "就请你当作我已不在" },
        { time: 76, text: "我睁开双眼看着空白" },
        { time: 81, text: "忘记你对我的期待" },
        { time: 85, text: "读完了依赖" },
        { time: 87, text: "我很快就离开" },
        { time: 114, text: "久未放晴的天空" },
        { time: 117, text: "依旧留着你的笑容" },
        { time: 122, text: "哭过却无法掩埋歉疚" },
        { time: 129, text: "风筝在阴天搁浅" },
        { time: 133, text: "想念还在等待救援" },
        { time: 138, text: "我拉着线复习你给的温柔" },
        { time: 144, text: "曝晒在一旁的寂寞" },
        { time: 148, text: "笑我给不起承诺" },
        { time: 151, text: "怎么会怎么会你竟原谅了我" },
        { time: 159, text: "我只能永远读着对白" },
        { time: 163, text: "读着我给你的伤害" },
        { time: 167, text: "我原谅不了我" },
        { time: 170, text: "就请你当作我已不在" },
        { time: 174, text: "我睁开双眼看着空白" },
        { time: 178, text: "忘记你对我的期待" },
        { time: 182, text: "读完了依赖" },
        { time: 185, text: "我很快就" },
        { time: 188, text: "我只能永远读着对白" },
        { time: 194, text: "读着我给你的伤害" },
        { time: 198, text: "我原谅不了我" },
        { time: 201, text: "就请你当作我已不在" },
        { time: 206, text: "我睁开双眼看着空白" },
        { time: 210, text: "忘记你对我的期待" },
        { time: 214, text: "读完了依赖" },
        { time: 217, text: "我很快就离开" }
      ]
    }
  ),
  createSong(
  ...
  createSong(
    ...
    "花海",
    ["想被安静陪着", "想回到从前"],
    AUDIO_NORMAL_BASE_URL + "hua-hai.mp3",
    "适合温柔一点的时候听，像风吹过一片花海。",
    {
      lyricsTimed: [
        { time: 0, text: "花海 - 周杰伦 (Jay Chou)" },
        { time: 27, text: "静止了 所有的花开" },
        { time: 33, text: "遥远了 清晰了爱" },
        { time: 39, text: "天郁闷 爱却很喜欢" },
        { time: 46, text: "那时候我不懂这叫爱" },
        { time: 52, text: "你喜欢 站在那窗台" },
        { time: 59, text: "你好久 都没再来" },
        { time: 65, text: "彩色的时间染上空白" },
        { time: 72, text: "是你流的泪晕开" },
        { time: 77, text: "不要你离开" },
        { time: 80, text: "距离隔不开" },
        { time: 83, text: "思念变成海" },
        { time: 86, text: "在窗外进不来" },
        { time: 90, text: "原谅说太快" },
        { time: 93, text: "爱成了阻碍" },
        { time: 96, text: "手中的风筝放太快回不来" },
        { time: 103, text: "不要你离开" },
        { time: 106, text: "回忆划不开" },
        { time: 109, text: "欠你的宠爱" },
        { time: 112, text: "我在等待重来" },
        { time: 115, text: "天空仍灿烂" },
        { time: 119, text: "它爱着大海" },
        { time: 122, text: "情歌被打败" },
        { time: 125, text: "爱已不存在" },
        { time: 155, text: "你喜欢 站在那窗台" },
        { time: 161, text: "你好久 都没再来" },
        { time: 167, text: "彩色的时间染上空白" },
        { time: 175, text: "是你流的泪晕开" },
        { time: 179, text: "不要你离开" },
        { time: 183, text: "距离隔不开" },
        { time: 186, text: "思念变成海" },
        { time: 189, text: "在窗外进不来" },
        { time: 192, text: "原谅说太快" },
        { time: 195, text: "爱成了阻碍" },
        { time: 199, text: "手中的风筝放太快回不来" },
        { time: 205, text: "不要你离开" },
        { time: 208, text: "回忆划不开" },
        { time: 211, text: "欠你的宠爱" },
        { time: 214, text: "我在等待重来" },
        { time: 218, text: "天空仍灿烂" },
        { time: 221, text: "它爱着大海" },
        { time: 224, text: "情歌被打败" },
        { time: 227, text: "爱已不存在" }
  ...
  createSong(
    ...
    "简单爱",
    ["想听甜一点", "想放空一下", "想回到从前"],
    AUDIO_NORMAL_BASE_URL + "jian-dan-ai.mp3",
    "适合把喜欢说得简单一点，轻轻松松就很好。",
    {
      lyricsTimed: [
        { time: 0, text: "简单爱 - 周杰伦 (Jay Chou)" },
        { time: 0, text: "想 简简单单 爱" },
        { time: 26, text: "说不上为什么 我变得很主动" },
        { time: 31, text: "若爱上一个人 什么都会值得去做" },
        { time: 36, text: "我想大声宣布 对你依依不舍" },
        { time: 41, text: "连隔壁邻居都猜到我现在的感受" },
        { time: 46, text: "河边的风 在吹着头发 飘动" },
        { time: 51, text: "牵着你的手 一阵莫名感动" },
        { time: 56, text: "我想带你 回我的外婆家" },
        { time: 60, text: "一起看着日落 一直到我们都睡着" },
        { time: 66, text: "我想就这样牵着你的手不放开" },
        { time: 71, text: "爱能不能够永远单纯没有悲哀" },
        { time: 76, text: "我 想带你骑单车" },
        { time: 78, text: "我 想和你看棒球" },
        { time: 81, text: "想这样没担忧" },
        { time: 83, text: "唱着歌 一直走" },
        { time: 86, text: "我想就这样牵着你的手不放开" },
        { time: 91, text: "爱可不可以简简单单没有伤害" },
        { time: 95, text: "你 靠着我的肩膀" },
        { time: 98, text: "你 在我胸口睡着" },
        { time: 101, text: "像这样的生活" },
        { time: 103, text: "我爱你 你爱我" },
        { time: 115, text: "想 简简单单 爱" },
        { time: 125, text: "我想大声宣布 对你依依不舍" },
        { time: 130, text: "连隔壁邻居都猜到我现在的感受" },
        { time: 135, text: "河边的风 在吹着头发 飘动" },
        { time: 140, text: "牵着你的手 一阵莫名感动" },
        { time: 145, text: "我想带你 回我的外婆家" },
        { time: 149, text: "一起看着日落 一直到我们都睡着" },
        { time: 155, text: "我想就这样牵着你的手不放开" },
        { time: 160, text: "爱能不能够永远单纯没有悲哀" },
        { time: 164, text: "我 想带你骑单车" },
        { time: 167, text: "我 想和你看棒球" },
        { time: 170, text: "想这样没担忧" },
        { time: 172, text: "唱着歌 一直走" },
        { time: 175, text: "我想就这样牵着你的手不放开" },
        { time: 180, text: "爱可不可以简简单单没有伤害" },
        { time: 184, text: "你 靠着我的肩膀" },
        { time: 187, text: "你 在我胸口睡着" },
        { time: 190, text: "像这样的生活" },
        { time: 192, text: "我爱你 你爱我" },
        { time: 194, text: "想 简简单单 爱" },
        { time: 204, text: "想 简简单单 爱" },
        { time: 214, text: "我想就这样牵着你的手不放开" },
        { time: 219, text: "爱能不能够永远单纯没有悲哀" },
        { time: 224, text: "我 想带你骑单车" },
        { time: 226, text: "我 想和你看棒球" },
        { time: 230, text: "想这样没担忧" },
        { time: 231, text: "唱着歌 一直走" },
        { time: 234, text: "我想就这样牵着你的手不放开" },
        { time: 239, text: "爱可不可以简简单单没有伤害" },
        { time: 244, text: "你 靠着我的肩膀" },
        { time: 246, text: "你 在我胸口睡着" },
        { time: 249, text: "像这样的生活" },
        { time: 251, text: "我爱你 你爱我" }
      ]
    }
  ),
  createSong(
    ...
    "借口",
    ["有点 emo", "想被安静陪着"],
    AUDIO_NORMAL_BASE_URL + "jie-kou.mp3",
    "适合有点嘴硬的时候听，不用急着解释。",
    {
      lyricsTimed: [
        { time: 0, text: "借口 - 周杰伦 (Jay Chou)" },
        { time: 15, text: "翻着我们的照片" },
        { time: 18, text: "想念若隐若现" },
        { time: 22, text: "去年的冬天" },
        { time: 25, text: "我们笑得很甜" },
        { time: 30, text: "看着你哭泣的脸" },
        { time: 33, text: "对着我说再见" },
        { time: 36, text: "来不及听见" },
        { time: 40, text: "你已走得很远" },
        { time: 44, text: "也许你已经放弃我" },
        { time: 47, text: "也许已经很难回头" },
        { time: 51, text: "我知道是自己错过" },
        { time: 55, text: "请再给我一个理由说你不爱我" },
        { time: 63, text: "就算是我不懂" },
        { time: 66, text: "能不能原谅我" },
        { time: 70, text: "请不要把分手当作你的请求" },
        { time: 77, text: "我知道坚持要走是你受伤的借口" },
        { time: 84, text: "请你回头" },
        { time: 86, text: "我会陪你一直走到最后" },
        { time: 92, text: "就算没有结果" },
        { time: 95, text: "我也能够承受" },
        { time: 99, text: "我知道你的痛" },
        { time: 102, text: "是我给的承诺" },
        { time: 106, text: "你说给过我纵容" },
        { time: 110, text: "沉默是因为包容" },
        { time: 113, text: "如果要走请你记得我" },
        { time: 132, text: "翻着我们的照片" },
        { time: 135, text: "想念若隐若现" },
        { time: 139, text: "去年的冬天" },
        { time: 143, text: "我们笑得很甜" },
        { time: 147, text: "看着你哭泣的脸" },
        { time: 150, text: "对着我说再见" },
        { time: 154, text: "来不及听见" },
        { time: 157, text: "你已走得很远" },
        { time: 161, text: "也许你已经放弃我" },
        { time: 165, text: "也许已经很难回头" },
        { time: 168, text: "我知道是自己错过" },
        { time: 172, text: "请再给我一个理由说你不爱我" },
        { time: 180, text: "就算是我不懂" },
        { time: 183, text: "能不能原谅我" },
        { time: 187, text: "请不要把分手当作你的请求" },
        { time: 194, text: "我知道坚持要走是你受伤的借口" },
        { time: 201, text: "请你回头" },
        { time: 203, text: "我会陪你一直走到最后" },
        { time: 209, text: "就算没有结果" },
        { time: 213, text: "我也能够承受" },
        { time: 217, text: "我知道你的痛" },
        { time: 220, text: "是我给的承诺" },
        { time: 224, text: "你说给过我纵容" },
        { time: 227, text: "沉默是因为包容" },
        { time: 231, text: "如果要走请你记得我" },
        { time: 242, text: "如果难过请你忘了我" }
      ]
    }
  ),
  createSong(
    ...
    "兰亭序",
    ["想被安静陪着"],
    AUDIO_NORMAL_BASE_URL + "lan-ting-xu.mp3",
    "适合想安静下来时听，字句像墨慢慢晕开。",
    {
      lyricsTimed: [
        { time: 0, text: "兰亭序 - 周杰伦 (Jay Chou)" },
        { time: 26, text: "兰亭临帖 行书如行云流水" },
        { time: 32, text: "月下门推 心细如你脚步碎" },
        { time: 38, text: "忙不迭 千年碑易拓" },
        { time: 42, text: "却难拓你的美" },
        { time: 46, text: "真迹绝 真心能给谁" },
        { time: 51, text: "牧笛横吹 黄酒小菜又几碟" },
        { time: 57, text: "夕阳余晖 如你的羞怯似醉" },
        { time: 63, text: "摹本易写" },
        { time: 65, text: "而墨香不退与你同留余味" },
        { time: 71, text: "一行朱砂 到底圈了谁" },
        { time: 76, text: "无关风月 我题序等你回" },
        { time: 82, text: "悬笔一绝 那岸边浪千叠" },
        { time: 89, text: "情字何解 怎落笔都不对" },
        { time: 95, text: "而我独缺 你一生的了解" },
        { time: 103, text: "无关风月 我题序等你回" },
        { time: 106, text: "悬笔一绝 那岸边浪千叠" },
        { time: 109, text: "情字何解 怎落笔都不对" },
        { time: 112, text: "而我独缺 你一生的了解" },
        { time: 115, text: "无关风月 我题序等你回" },
        { time: 119, text: "悬笔一绝 那岸边浪千叠" },
        { time: 122, text: "情字何解 怎落笔都不对" },
        { time: 125, text: "独缺 你一生了解" },
        { time: 127, text: "弹指岁月 倾城顷刻间湮灭" },
        { time: 133, text: "青石板街 回眸一笑你婉约" },
        { time: 139, text: "恨了没" },
        { time: 141, text: "你摇头轻叹谁让你蹙着眉" },
        { time: 147, text: "而深闺 徒留胭脂味" },
        { time: 152, text: "人雁南飞 转身一瞥你噙泪" },
        { time: 158, text: "掬一把月 手揽回忆怎么睡" },
        { time: 165, text: "又怎么会" },
        { time: 167, text: "心事密缝绣花鞋针针怨怼" },
        { time: 172, text: "若花怨蝶 你会怨着谁" },
        { time: 177, text: "无关风月 我题序等你回" },
        { time: 183, text: "悬笔一绝 那岸边浪千叠" },
        { time: 190, text: "情字何解 怎落笔都不对" },
        { time: 196, text: "而我独缺 你一生的了解" },
        { time: 203, text: "无关风月 我题序等你回" },
        { time: 210, text: "手书无愧 无惧人间是非" },
        { time: 217, text: "雨打蕉叶 又潇潇了几夜" },
        { time: 223, text: "我等春雷 来提醒你爱谁" }
      ]
    }
  ),
  ...
  createSong(
    ...
    "七里香",
    ["想听甜一点", "想放空一下", "想回到从前"],
    AUDIO_NORMAL_BASE_URL + "qi-li-xiang.mp3",
    "适合清新的心情，像风里有一点夏天的味道。",
    {
      lyricsTimed: [
        { time: 0, text: "七里香 - 周杰伦 (Jay Chou)" },
        { time: 27, text: "窗外的麻雀在电线杆上多嘴" },
        { time: 34, text: "你说这一句很有夏天的感觉" },
        { time: 41, text: "手中的铅笔在纸上来来回回" },
        { time: 47, text: "我用几行字形容你是我的谁" },
        { time: 54, text: "秋刀鱼的滋味猫跟你都想了解" },
        { time: 61, text: "初恋的香味就这样被我们寻回" },
        { time: 67, text: "那温暖的阳光像刚摘的鲜艳草莓" },
        { time: 74, text: "你说你舍不得吃掉这一种感觉" },
        { time: 80, text: "雨下整夜我的爱溢出就像雨水" },
        { time: 87, text: "院子落叶跟我的思念厚厚一叠" },
        { time: 94, text: "几句是非也无法将我的热情冷却" },
        { time: 101, text: "你出现在我诗的每一页" },
        { time: 107, text: "雨下整夜我的爱溢出就像雨水" },
        { time: 114, text: "窗台蝴蝶像诗里纷飞的美丽章节" },
        { time: 121, text: "我接着写" },
        { time: 123, text: "把永远爱你写进诗的结尾" },
        { time: 128, text: "你是我唯一想要的了解" },
        { time: 162, text: "雨下整夜我的爱溢出就像雨水" },
        { time: 168, text: "院子落叶跟我的思念厚厚一叠" },
        { time: 175, text: "几句是非也无法将我的热情冷却" },
        { time: 182, text: "你出现在我诗的每一页" },
        { time: 189, text: "那饱满的稻穗幸福了这个季节" },
        { time: 192, text: "而你的脸颊像田里熟透的番茄" },
        { time: 202, text: "你突然对我说七里香的名字很美" },
        { time: 209, text: "我此刻却只想亲吻你倔强的嘴" },
        { time: 215, text: "雨下整夜我的爱溢出就像雨水" },
        { time: 222, text: "院子落叶跟我的思念厚厚一叠" },
        { time: 229, text: "几句是非也无法将我的热情冷却" },
        { time: 236, text: "你出现在我诗的每一页" },
        { time: 243, text: "整夜我的爱溢出就像雨水" },
        { time: 249, text: "窗台蝴蝶像诗里纷飞的美丽章节" },
        { time: 256, text: "我接着写" },
        { time: 258, text: "把永远爱你写进诗的结尾" },
        { time: 264, text: "你是我唯一想要的了解" }
      ]
    }
  ),
  createSong(
  ...
  createSong(
    ...
    "珊瑚海",
    ["有点 emo", "想被安静陪着"],
    AUDIO_NORMAL_BASE_URL + "shan-hu-hai.mp3",
    "适合有些没说完的心情，像潮水慢慢退去。",
    {
      lyricsTimed: [
        { time: 0, text: "珊瑚海 - 周杰伦 (Jay Chou)/Lara梁心颐 (lara Liang)" },
        { time: 13, text: "男：" },
        { time: 15, text: "海平面远方开始阴霾" },
        { time: 21, text: "悲伤要怎么平静纯白" },
        { time: 27, text: "我的脸上始终挟带" },
        { time: 33, text: "一抹浅浅的无奈" },
        { time: 41, text: "女：" },
        { time: 41, text: "你用唇语说你要离开" },
        { time: 45, text: "男：" },
        { time: 45, text: "心不在" },
        { time: 47, text: "合：" },
        { time: 48, text: "那难过无声慢了下来" },
        { time: 53, text: "汹涌潮水你听明白" },
        { time: 60, text: "不是浪而是泪海" },
        { time: 66, text: "男：" },
        { time: 66, text: "转身离开" },
        { time: 68, text: "女：" },
        { time: 68, text: "你有话说不出来" },
        { time: 70, text: "男：" },
        { time: 70, text: "分手说不出来" },
        { time: 71, text: "合：" },
        { time: 72, text: "海鸟跟鱼相爱" },
        ...
        { time: 86, text: "风中尘埃" },
        { time: 87, text: "合：" },
        { time: 88, text: "等待竟累积成伤害" },
        { time: 92, text: "转身离开" },
        { time: 95, text: "分手说不出来" },
        { time: 98, text: "蔚蓝的珊瑚海" },
        { time: 101, text: "错过瞬间苍白" },
        { time: 104, text: "男：" },
        { time: 105, text: "当初彼此" },
        { time: 106, text: "女：" },
        { time: 106, text: "你我都" },
        { time: 107, text: "合：" },
        { time: 108, text: "不够成熟坦白" },
        { time: 111, text: "女：" },
        { time: 111, text: "不应该" },
        { time: 112, text: "男：" },
        { time: 112, text: "热情不再" },
        { time: 114, text: "合：" },
        { time: 114, text: "你的笑容勉强不来" },
        { time: 118, text: "爱深埋珊瑚海" },
        { time: 124, text: "男：" },
        { time: 126, text: "毁坏的沙雕如何重来" },
        { time: 133, text: "有裂痕的爱怎么重盖" },
        { time: 138, text: "只是一切结束太快" },
        { time: 145, text: "你说你无法释怀" },
        { time: 151, text: "女：" },
        { time: 152, text: "贝壳里隐藏什么期待" },
        { time: 157, text: "男：" },
        { time: 157, text: "等花儿开" },
        { time: 158, text: "合：" },
        { time: 159, text: "我们也已经无心再猜" },
        { time: 164, text: "女：" },
        { time: 165, text: "面向海风" },
        { time: 166, text: "男：" },
        { time: 166, text: "面向海风" },
        ...
        { time: 170, text: "咸咸的爱" },
        { time: 171, text: "合：" },
        { time: 171, text: "尝不出还有未来" },
        { time: 178, text: "男：" },
        { time: 178, text: "转身离开" },
        { time: 180, text: "女：" },
        { time: 180, text: "你有话说不出来" },
        { time: 182, text: "男：" },
        { time: 182, text: "分手说不出来" },
        { time: 183, text: "合：" },
        { time: 184, text: "海鸟跟鱼相爱" },
        { time: 187, text: "只是一场意外" },
        { time: 190, text: "男：" },
        { time: 191, text: "我们的爱" },
        { time: 192, text: "女：" },
        { time: 192, text: "给的爱" },
        { time: 193, text: "合：" },
        { time: 194, text: "差异一直存在" },
        { time: 196, text: "女：" },
        { time: 197, text: "回不来" },
        { time: 198, text: "男：" },
        { time: 198, text: "风中尘埃" },
        ...
        { time: 199, text: "等待" },
        { time: 200, text: "合：" },
        { time: 200, text: "竟累积成伤害" },
        { time: 204, text: "转身离开" },
        { time: 207, text: "分手说不出来" },
        { time: 210, text: "蔚蓝的珊瑚海" },
        { time: 213, text: "错过瞬间苍白" },
        { time: 217, text: "男：" },
        { time: 217, text: "当初彼此" },
        { time: 219, text: "女：" },
        { time: 219, text: "你我都" },
        { time: 219, text: "合：" },
        { time: 220, text: "不够成熟坦白" },
        { time: 223, text: "女：" },
        { time: 223, text: "不应该" },
        { time: 224, text: "男：" },
        { time: 224, text: "热情不再" },
        { time: 225, text: "合：" },
        { time: 226, text: "你的笑容勉强不来" },
        { time: 230, text: "爱深埋珊瑚海" }
      ]
    }
  ),
  createSong(
    ...
    "说好的幸福呢",
    ["有点 emo", "想被安静陪着"],
    AUDIO_NORMAL_BASE_URL + "shuo-hao-de-xing-fu-ne.mp3",
    "适合安静听完，不用假装没关系。",
    {
      lyricsTimed: [
        { time: 0, text: "说好的幸福呢 - 周杰伦 (Jay Chou)" },
        { time: 22, text: "你的回话凌乱着" },
        { time: 27, text: "在这个时刻" },
        { time: 30, text: "我想起喷泉旁的白鸽" },
        { time: 35, text: "甜蜜散落了" },
        { time: 38, text: "情绪莫名的拉扯" },
        { time: 43, text: "我还爱你呢" },
        { time: 46, text: "而你断断续续唱着歌" },
        { time: 51, text: "假装没事了" },
        { time: 54, text: "时间过了走了" },
        { time: 57, text: "爱情面临选择" },
        { time: 59, text: "你冷了倦了我哭了" },
        { time: 63, text: "离开时的不快乐" },
        { time: 65, text: "你用卡片手写着" },
        { time: 67, text: "有些爱只给到这" },
        { time: 68, text: "真的痛了" },
        { time: 73, text: "怎么了你累了" },
        { time: 75, text: "说好的幸福呢" },
        { time: 77, text: "我懂了不说了" },
        { time: 79, text: "爱淡了梦远了" },
        { time: 81, text: "开心与不开心" },
        { time: 83, text: "一一细数着你再不舍" },
        { time: 85, text: "那些爱过的感觉都太深刻" },
        { time: 88, text: "我都还记得" },
        { time: 90, text: "你不等了" },
        { time: 91, text: "说好的幸福呢" },
        { time: 93, text: "我错了泪干了" },
        { time: 95, text: "放手了后悔了" },
        { time: 97, text: "只是回忆的音乐盒还旋转着" },
        { time: 101, text: "要怎么停呢" },
        { time: 116, text: "你的回话凌乱着" },
        { time: 120, text: "在这个时刻" },
        { time: 124, text: "我想起喷泉旁的白鸽" },
        { time: 129, text: "甜蜜散落了" },
        { time: 132, text: "情绪莫名的拉扯" },
        { time: 137, text: "我还爱你呢" },
        { time: 140, text: "而你断断续续唱着歌" },
        { time: 145, text: "假装没事了" },
        { time: 148, text: "时间过了走了" },
        { time: 151, text: "爱情面临选择" },
        { time: 153, text: "你冷了倦了我哭了" },
        { time: 157, text: "离开时的不快乐" },
        { time: 159, text: "你用卡片手写着" },
        { time: 161, text: "有些爱只给到这真的痛了" },
        { time: 167, text: "怎么了你累了" },
        { time: 169, text: "说好的幸福呢" },
        { time: 171, text: "我懂了不说了" },
        { time: 173, text: "爱淡了梦远了" },
        { time: 175, text: "开心与不开心" },
        { time: 176, text: "一一细数着你再不舍" },
        { time: 179, text: "那些爱过的感觉都太深刻" },
        { time: 182, text: "我都还记得" },
        { time: 184, text: "你不等了说好的幸福呢" },
        { time: 187, text: "我错了泪干了" },
        { time: 189, text: "放手了后悔了" },
        { time: 191, text: "只是回忆的音乐盒还旋转着" },
        { time: 195, text: "要怎么停呢" },
        { time: 199, text: "怎么了你累了" },
        { time: 204, text: "说好的幸福呢" },
        { time: 207, text: "我懂了不说了爱淡了" },
        { time: 213, text: "梦远了我都还记得" },
        { time: 217, text: "你不等了说好的幸福呢" },
        { time: 220, text: "我错了泪干了" },
        { time: 222, text: "放手了后悔了" },
        { time: 224, text: "只是回忆的音乐盒还旋转着" },
        { time: 228, text: "要怎么停呢" }
      ]
    }
  ),
  ...
  createSong(
    "suan-shen-me-nan-ren",
    "算什么男人",
    ["有点 emo"],
    AUDIO_NORMAL_BASE_URL + "suan-shen-me-nan-ren.mp3",
    "适合情绪有点上来的时候，先让歌替你说完。",
    {
      lyricsTimed: [
        { time: 0, text: "算什么男人 - 周杰伦 (Jay Chou)" },
        { time: 37, text: "亲吻你的手" },
        { time: 40, text: "还靠着你的头" },
        { time: 42, text: "让你躺胸口" },
        { time: 44, text: "那个人已不是我" },
        { time: 47, text: "这些平常的举动现在叫做难过" },
        { time: 52, text: "喔 难过" },
        { time: 55, text: "日子开始过" },
        { time: 57, text: "我没你照样过" },
        { time: 60, text: "不会很难受" },
        { time: 62, text: "我会默默的接受" },
        { time: 64, text: "反正在一起时你我都有开心过" },
        { time: 69, text: "就足够" },
        { time: 73, text: "我的温暖你的冷漠让爱起雾了" },
        { time: 78, text: "如果爱心画在起雾的窗是模糊" },
        { time: 85, text: "还是更清楚" },
        { time: 89, text: "你算什么男人" },
        { time: 92, text: "算什么男人" },
        { time: 94, text: "眼睁睁看她走却不闻不问" },
        { time: 98, text: "是有多天真 就别再硬撑" },
        { time: 103, text: "期待你挽回你却拱手让人" },
        { time: 107, text: "你算什么男人" },
        { time: 110, text: "算什么男人" },
        { time: 112, text: "还爱着她却不敢叫她再等" },
        { time: 116, text: "没差 你再继续认份" },
        { time: 119, text: "她会遇到更好的男人" },
        { time: 141, text: "亲吻你的手" },
        { time: 143, text: "还靠着你的头" },
        { time: 145, text: "让你躺胸口" },
        { time: 147, text: "那个人已不是我" },
        { time: 150, text: "这些平常的举动现在叫做难过" },
        { time: 155, text: "喔 难过" },
        { time: 159, text: "日子开始过" },
        { time: 161, text: "我没你照样过" },
        { time: 163, text: "不会很难受" },
        { time: 165, text: "我会默默的接受" },
        { time: 167, text: "反正在一起时你我都有开心过" },
        { time: 173, text: "就足够" },
        { time: 177, text: "我的温暖你的冷漠让爱起雾了" },
        { time: 181, text: "如果爱心画在起雾的窗是模糊" },
        { time: 188, text: "还是更清楚" },
        { time: 193, text: "你算什么男人" },
        { time: 195, text: "算什么男人" },
        { time: 197, text: "眼睁睁看她走却不闻不问" },
        { time: 201, text: "是有多天真 就别再硬撑" },
        { time: 206, text: "期待你挽回你却拱手让人" },
        { time: 210, text: "你算什么男人" },
        { time: 213, text: "算什么男人" },
        { time: 215, text: "还爱着她却不敢叫她再等" },
        { time: 219, text: "没差 你再继续认份" },
        { time: 222, text: "她会遇到更好的男人" },
        { time: 229, text: "你算什么男人" },
        { time: 231, text: "算什么男人" },
        { time: 233, text: "眼睁睁看她走却不闻不问" },
        { time: 237, text: "是有多天真 就别再硬撑" },
        { time: 242, text: "期待你挽回却拱手让人" },
        { time: 246, text: "你算什么男人" },
        { time: 249, text: "算什么男人" },
        { time: 251, text: "还爱着她却不敢叫她再等" },
        { time: 255, text: "没差 你再继续认份" },
        { time: 258, text: "她会遇到更好的男人" }
      ]
    }
  ),
  createSong(
    ...
    "甜甜的",
    ["想听甜一点", "想放空一下"],
    AUDIO_NORMAL_BASE_URL + "tian-tian-de.mp3",
    "适合心情软软的时候听，像一口甜甜的气泡水。",
    {
      lyricsTimed: [
        { time: 0, text: "甜甜的 - 周杰伦 (Jay Chou)" },
        { time: 1, text: "我轻轻地尝一口" },
        { time: 4, text: "你说的爱我" },
        { time: 5, text: "还在回味你给过的温柔" },
        { time: 10, text: "我轻轻地尝一口" },
        { time: 12, text: "这香浓的诱惑" },
        { time: 14, text: "我喜欢的样子你都有" },
        { time: 24, text: "你爱过头 竟然答应我" },
        { time: 28, text: "要给我蜂蜜口味的生活" },
        { time: 32, text: "加一颗奶球 我搅拌害羞" },
        { time: 36, text: "将甜度调高后再牵手" },
        { time: 41, text: "你的爱太多 想随身带走" },
        { time: 44, text: "想你的时候 就吃上一口" },
        { time: 49, text: "我温热着 被呵护的感受" },
        { time: 53, text: "却又担心降温了要求" },
        { time: 57, text: "我尝着你话里面的奶油溜啊溜" },
        { time: 61, text: "听过的每句话都很可口呦啊呦" },
        { time: 66, text: "那些多余的画面全被跳过" },
        { time: 70, text: "你的眼中只有我" },
        { time: 74, text: "Oh oh" },
        { time: 76, text: "我轻轻地尝一口你说的爱我" },
        { time: 80, text: "还在回味你给过的温柔" },
        { time: 84, text: "我轻轻地尝一口 这香浓的诱惑" },
        { time: 88, text: "我喜欢的样子你都有" },
        { time: 92, text: "我轻轻地尝一口你说的爱我" },
        { time: 96, text: "舍不得吃会微笑的糖果" },
        { time: 101, text: "我轻轻地尝一口 份量虽然不多" },
        { time: 105, text: "却将你的爱完全吸收" },
        { time: 128, text: "我微笑着 让香味停留" },
        { time: 131, text: "缘分走到这也赖着不走" },
        { time: 136, text: "像夹心饼干 中间有甜头" },
        { time: 140, text: "继续下去不需要理由" },
        { time: 144, text: "我尝着你话里面的奶油溜啊溜" },
        { time: 148, text: "听过的每句话都很可口呦啊呦" },
        { time: 152, text: "那些多余的画面全被跳过" },
        { time: 157, text: "你的眼中只有我" },
        { time: 163, text: "我轻轻地尝一口 你说的爱我" },
        { time: 167, text: "还在回味你给过的温柔" },
        { time: 171, text: "我轻轻地尝一口这香浓的诱惑" },
        { time: 175, text: "我喜欢的样子你都有" },
        { time: 179, text: "我轻轻地尝一口 你说的爱我" },
        { time: 183, text: "舍不得吃会微笑的糖果" },
        { time: 187, text: "我轻轻地尝一口 份量虽然不多" },
        { time: 192, text: "却将你的爱完全吸收" },
        { time: 196, text: "我轻轻地尝一口 你说的爱我" },
        { time: 200, text: "还在回味你给过的温柔" },
        { time: 204, text: "我轻轻地尝一口味道香浓的说" },
        { time: 208, text: "我喜欢的样子你都有" },
        { time: 212, text: "我轻轻地尝一口 你说的爱我" },
        { time: 216, text: "舍不得吃会微笑的糖果" },
        { time: 220, text: "我轻轻地尝一口 份量虽然不多" },
        { time: 225, text: "却将你的爱完全吸收" }
      ]
    }
  ),
  createSong(
    ...
    "退后",
    ["有点 emo", "想被安静陪着"],
    AUDIO_NORMAL_BASE_URL + "tui-hou.mp3",
    "适合想慢慢退回安全距离的时候听。",
    {
      lyricsTimed: [
        { time: 0, text: "退后 - 周杰伦 (Jay Chou)" },
        { time: 23, text: "天空灰得像哭过" },
        { time: 28, text: "离开你以后 并没有 更自由" },
        { time: 35, text: "酸酸的空气 嗅出我们的距离" },
        { time: 41, text: "一幕锥心的结局" },
        { time: 45, text: "像呼吸般无法停息" },
        { time: 52, text: "抽屉泛黄的日记" },
        { time: 56, text: "榨干了回忆" },
        { time: 59, text: "那笑容 是夏季" },
        { time: 64, text: "你我的过去被顺时针的忘记" },
        { time: 70, text: "缺氧过后的爱情" },
        { time: 74, text: "粗心的眼泪是多余" },
        { time: 79, text: "我知道你我都没有错" },
        { time: 83, text: "只是忘了怎么退后" },
        { time: 87, text: "信誓旦旦给了承诺" },
        { time: 91, text: "却被时间扑了空" },
        { time: 94, text: "我知道我们都没有错" },
        { time: 98, text: "只是放手会比较好过" },
        { time: 105, text: "最美的爱情 回忆里待续" },
        { time: 125, text: "天空灰得像哭过" },
        { time: 129, text: "离开你以后 并没有 更自由" },
        { time: 137, text: "酸酸的空气 嗅出我们的距离" },
        { time: 143, text: "一幕锥心的结局" },
        { time: 146, text: "像呼吸般无法停息" },
        { time: 154, text: "抽屉泛黄的日记" },
        { time: 158, text: "榨干了回忆" },
        { time: 161, text: "那笑容 是夏季" },
        { time: 165, text: "你我的过去被顺时针的忘记" },
        { time: 172, text: "缺氧过后的爱情" },
        { time: 176, text: "粗心的眼泪是多余" },
        { time: 181, text: "我知道你我都没有错" },
        { time: 185, text: "只是忘了怎么退后" },
        { time: 189, text: "信誓旦旦给了承诺" },
        { time: 192, text: "却被时间扑了空" },
        { time: 196, text: "我知道我们都没有错" },
        { time: 200, text: "只是放手会比较好过" },
        { time: 207, text: "最美的爱情 回忆里待续" },
        { time: 211, text: "我知道你我都没有错" },
        { time: 214, text: "只是忘了怎么退后" },
        { time: 218, text: "信誓旦旦给了承诺" },
        { time: 221, text: "却被时间扑了空" },
        { time: 225, text: "我知道我们都没有错" },
        { time: 229, text: "只是放手会比较好过" },
        { time: 236, text: "最美的爱情 回忆里待续" }
      ]
    }
  ),
  createSong(
  ...
  createSong(
    ...
    "我是如此相信",
    ["想被安静陪着", "想放空一下"],
    AUDIO_NORMAL_BASE_URL + "wo-shi-ru-ci-xiang-xin.mp3",
    "适合需要一点信念的时候，慢慢把心放稳。",
    {
      lyricsTimed: [
        { time: 0, text: "我是如此相信 - 周杰伦 (Jay Chou)" },
        { time: 37, text: "鸟群离开了森林" },
        { time: 41, text: "整座天空很灰心" },
        { time: 44, text: "蝴蝶不再被吸引" },
        { time: 48, text: "玫瑰盛开的很安静" },
        { time: 51, text: "远方的风雨不停" },
        { time: 55, text: "城市苍白而孤寂" },
        { time: 58, text: "徘徊无助的人群" },
        { time: 61, text: "焦虑着何时放晴" },
        { time: 65, text: "故事里能毁坏的只有风景" },
        { time: 68, text: "谁也摧毁不了我们的梦境" },
        { time: 72, text: "弦月旁的流星划过了天际" },
        { time: 74, text: "我许下 的愿望 该向谁 去说明" },
        { time: 79, text: "陨石在浩瀚的宇宙间旅行" },
        { time: 82, text: "璀璨的夜空里漫天的水晶" },
        { time: 85, text: "我的祷告终于有了回音" },
        { time: 90, text: "我是如此相信" },
        { time: 93, text: "在背后支撑的是你" },
        { time: 96, text: "一直与我并肩而行" },
        { time: 100, text: "仰望等太阳升起" },
        { time: 102, text: "听见鸟群回来的声音" },
        { time: 107, text: "为我守候的人是你" },
        { time: 110, text: "给了我坚定的信心" },
        { time: 114, text: "双手弹奏出黎明" },
        { time: 116, text: "原来爱如此的动听" },
        { time: 135, text: "鸟群离开了森林" },
        { time: 138, text: "整座天空很灰心" },
        { time: 142, text: "蝴蝶不再被吸引" },
        { time: 145, text: "玫瑰盛开的很安静" },
        { time: 148, text: "远方的风雨不停" },
        { time: 152, text: "城市苍白而孤寂" },
        { time: 156, text: "徘徊无助的人群" },
        { time: 159, text: "焦虑着何时放晴" },
        { time: 162, text: "故事里能毁坏的只有风景" },
        { time: 166, text: "谁也摧毁不了我们的梦境" },
        { time: 169, text: "弦月旁的流星划过了天际" },
        { time: 172, text: "我许下 的愿望 该向谁 去说明" },
        { time: 176, text: "陨石在浩瀚的宇宙间旅行" },
        { time: 179, text: "璀璨的夜空里漫天的水晶" },
        { time: 183, text: "我的祷告终于有了回音" },
        { time: 187, text: "我是如此相信" },
        { time: 190, text: "在背后支撑的是你" },
        { time: 194, text: "一直与我并肩而行" },
        { time: 197, text: "仰望等太阳升起" },
        { time: 200, text: "听见鸟群回来的声音" },
        { time: 204, text: "为我守候的人是你" },
        { time: 207, text: "给了我坚定的信心" },
        { time: 211, text: "双手弹奏出黎明" },
        { time: 213, text: "原来爱如此的动听" },
        { time: 217, text: "我是如此相信" },
        { time: 218, text: "在背后支撑的是你" },
        { time: 221, text: "一直与我并肩而行" },
        { time: 225, text: "仰望等太阳升起" },
        { time: 227, text: "听见鸟群回来的声音" },
        { time: 232, text: "为我守候的人是你" },
        { time: 235, text: "给了我坚定的信心" },
        { time: 239, text: "双手弹奏出黎明" },
        { time: 241, text: "原来爱如此的动听" }
      ]
    }
  ),
  createSong(
    ...
    "星晴",
    ["想听甜一点", "想放空一下", "想回到从前"],
    AUDIO_NORMAL_BASE_URL + "xing-qing.mp3",
    "适合阳光刚好的时候，心情也跟着亮一点。",
    {
      lyricsTimed: [
        { time: 0, text: "星晴 - 周杰伦 (Jay Chou)" },
        { time: 11, text: "一步两步三步四步望着天手牵手" },
        { time: 16, text: "一颗两颗三颗四颗连成线看星星" },
        { time: 22, text: "一步两步三步四步望着天手牵手" },
        { time: 27, text: "一颗两颗三颗四颗连成线看星" },
        { time: 33, text: "乘着风游荡在蓝天边" },
        { time: 38, text: "一片云掉落在我面前" },
        { time: 44, text: "捏成你的形状" },
        { time: 46, text: "随风跟着我" },
        { time: 48, text: "一口一口吃掉忧愁" },
        { time: 55, text: "载着你仿佛载着阳光" },
        { time: 60, text: "不管到哪里都是晴天" },
        { time: 65, text: "蝴蝶自在飞" },
        { time: 68, text: "花也布满天" },
        { time: 70, text: "一朵一朵因你而香" },
        { time: 74, text: "试图让夕阳飞翔" },
        { time: 80, text: "带领你我环绕大自然" },
        { time: 88, text: "迎着风" },
        { time: 91, text: "开始共度每一天" },
        { time: 96, text: "手牵手" },
        { time: 97, text: "一步两步三步四步望着天" },
        { time: 101, text: "看星星一颗两颗三颗四颗连成线" },
        { time: 107, text: "背对背" },
        { time: 109, text: "默默许下心愿" },
        { time: 112, text: "看远方的星" },
        { time: 114, text: "是否听得见" },
        { time: 118, text: "手牵手" },
        { time: 119, text: "一步两步三步四步望着天" },
        { time: 123, text: "看星星一颗两颗三颗四颗连成线" },
        { time: 128, text: "背对背" },
        { time: 130, text: "默默许下心愿" },
        { time: 133, text: "看远方的星" },
        { time: 136, text: "如果听得见" },
        { time: 139, text: "它一定实现" },
        { time: 163, text: "载着你仿佛载着阳光" },
        { time: 168, text: "不管到哪里都是晴天" },
        { time: 173, text: "蝴蝶自在飞" },
        { time: 176, text: "花也布满天" },
        { time: 178, text: "一朵一朵因你而香" },
        { time: 182, text: "试图让夕阳飞翔" },
        { time: 188, text: "带领你我环绕大自然" },
        { time: 196, text: "迎着风" },
        { time: 199, text: "开始共度每一天" },
        { time: 204, text: "手牵手一步两步三步四步望着天" },
        { time: 209, text: "看星星一颗两颗三颗四颗连成线" },
        { time: 215, text: "背对背" },
        { time: 216, text: "默默许下心愿" },
        { time: 219, text: "看远方的星" },
        { time: 222, text: "是否听得见" },
        { time: 226, text: "手牵手一步两步三步四步望着天" },
        { time: 231, text: "看星星一颗两颗三颗四颗连成线" },
        { time: 236, text: "背对背" },
        { time: 238, text: "默默许下心愿" },
        { time: 241, text: "看远方的星" },
        { time: 243, text: "如果听得见" },
        { time: 247, text: "它一定实现" }
      ]
  ...
  createSong(
    ...
    "烟花易冷",
    ["有点 emo", "想被安静陪着"],
    AUDIO_NORMAL_BASE_URL + "yan-hua-yi-leng.mp3",
    "适合安静听，像一场慢慢落下的烟火。",
    {
      lyricsTimed: [
        { time: 0, text: "烟花易冷 - 周杰伦 (Jay Chou)" },
        { time: 11, text: "繁华声 遁入空门 折煞了世人" },
        { time: 18, text: "梦偏冷 辗转一生 情债又几本" },
        { time: 24, text: "如你默认 生死枯等" },
        { time: 30, text: "枯等一圈 又一圈的 年轮" },
        { time: 36, text: "浮屠塔 断了几层 断了谁的魂" },
        { time: 43, text: "痛直奔 一盏残灯 倾塌的山门" },
        { time: 49, text: "容我再等 历史转身" },
        { time: 55, text: "等酒香醇 等你弹 一曲古筝" },
        { time: 62, text: "雨纷纷 旧故里草木深" },
        { time: 68, text: "我听闻 你始终一个人" },
        { time: 74, text: "斑驳的城门 盘踞着老树根" },
        { time: 80, text: "石板上回荡的是 再等" },
        { time: 87, text: "雨纷纷 旧故里草木深" },
        { time: 93, text: "我听闻 你仍守着孤城" },
        { time: 99, text: "城郊牧笛声 落在那座野村" },
        { time: 105, text: "缘份落地生根是 我们" },
        { time: 114, text: "听青春 迎来笑声 羡煞许多人" },
        { time: 121, text: "那史册 温柔不肯 下笔都太狠" },
        { time: 127, text: "烟花易冷 人事易分" },
        { time: 133, text: "而你在问 我是否还 认真" },
        { time: 139, text: "千年后 累世情深 还有谁在等" },
        { time: 145, text: "而青史 岂能不真 魏书洛阳城" },
        { time: 152, text: "如你在跟 前世过门" },
        { time: 158, text: "跟着红尘 跟随我 浪迹一生" },
        { time: 164, text: "雨纷纷 旧故里草木深" },
        { time: 171, text: "我听闻 你始终一个人" },
        { time: 177, text: "斑驳的城门 盘踞着老树根" },
        { time: 183, text: "石板上回荡的是 再等" },
        { time: 189, text: "雨纷纷 旧故里草木深" },
        { time: 196, text: "我听闻 你仍守着孤城" },
        { time: 202, text: "城郊牧笛声 落在那座野村" },
        { time: 208, text: "缘份落地生根是 我们" },
        { time: 215, text: "雨纷纷 旧故里草木深" },
        { time: 216, text: "我听闻 你始终一个人" },
        { time: 218, text: "斑驳的城门 盘踞着老树根" },
        { time: 220, text: "石板上回荡的是 再等" },
        { time: 222, text: "雨纷纷 雨纷纷 旧故里草木深" },
        { time: 225, text: "我听闻 我听闻 你仍守着孤城" },
        { time: 227, text: "城郊牧笛声 落在那座野村" },
        { time: 233, text: "缘份落地生根是 我们" },
        { time: 239, text: "缘份落地生根是 我们" },
        { time: 245, text: "伽蓝寺听雨声盼 永恒" }
      ]
    }
  ),
  createSong(
    ...
    "一路向北",
    ["有点 emo", "想回到从前"],
    AUDIO_NORMAL_BASE_URL + "yi-lu-xiang-bei.mp3",
    "适合一个人往前走的时候，风会替你说话。",
    {
      lyricsTimed: [
        { time: 0, text: "一路向北 - 周杰伦" },
        { time: 35, text: "后视镜里的世界" },
        { time: 42, text: "越来越远的道别" },
        { time: 47, text: "你转身向背 侧脸还是很美" },
        { time: 53, text: "我用眼光去追 竟听见你的泪" },
        { time: 64, text: "在车窗外面徘徊 是我错失的机会" },
        { time: 75, text: "你站的方位 跟我中间隔着泪" },
        { time: 82, text: "街景一直在后退" },
        { time: 85, text: "你的崩溃在窗外零碎" },
        { time: 90, text: "我一路向北 离开有你的季节" },
        { time: 97, text: "你说你好累 已无法再爱上谁" },
        { time: 104, text: "风在山路吹" },
        { time: 107, text: "过往的画面全都是我不对" },
        { time: 112, text: "细数惭愧 我伤你几回" },
        { time: 139, text: "后视镜里的世界 越来越远的道别" },
        { time: 151, text: "你转身向背 侧脸还是很美" },
        { time: 157, text: "我用眼光去追 竟听见你的泪" },
        { time: 168, text: "在车窗外面徘徊 是我错失的机会" },
        { time: 180, text: "你站的方位 跟我中间隔着泪" },
        { time: 185, text: "街景一直在后退" },
        { time: 189, text: "你的崩溃在窗外零碎" },
        { time: 194, text: "我一路向北 离开有你的季节" },
        { time: 201, text: "你说你好累 已无法再爱上谁" },
        { time: 208, text: "风在山路吹" },
        { time: 211, text: "过往的画面全都是我不对" },
        { time: 216, text: "细数惭愧 我伤你几回" },
        { time: 222, text: "我一路向北 离开有你的季节" },
        { time: 230, text: "方向盘周围 回转着我的后悔" },
        { time: 237, text: "我加速超越" },
        { time: 239, text: "却甩不掉紧紧跟随的伤悲" },
        { time: 245, text: "细数惭愧我 伤你几回" },
        { time: 252, text: "停止狼狈就 让错纯粹" }
      ]
    }
  ),
  createSong(
    ...
    "最长的电影",
    ["有点 emo", "想被安静陪着", "想回到从前"],
    AUDIO_NORMAL_BASE_URL + "zui-chang-de-dian-ying.mp3",
    "适合像看完一场旧电影那样，慢慢收尾。",
    {
      lyricsTimed: [
        { time: 0, text: "最长的电影 - 周杰伦 (Jay Chou)" },
        { time: 15, text: "我们的开始" },
        { time: 19, text: "是很长的电影" },
        { time: 23, text: "放映了三年" },
        { time: 26, text: "我票都还留着" },
        { time: 31, text: "冰上的芭蕾" },
        { time: 35, text: "脑海中还在旋转" },
        { time: 40, text: "望着你 慢慢忘记你" },
        { time: 47, text: "朦胧的时间" },
        { time: 51, text: "我们溜了多远" },
        { time: 55, text: "冰刀划的圈" },
        { time: 58, text: "圈起了谁改变" },
        { time: 62, text: "如果再重来" },
        { time: 67, text: "会不会稍嫌狼狈" },
        { time: 71, text: "爱是不是不开口才珍贵" },
        { time: 78, text: "再给我两分钟" },
        { time: 82, text: "让我把记忆结成冰" },
        { time: 86, text: "别融化了眼泪" },
        { time: 89, text: "你妆都花了要我怎么记得" },
        { time: 94, text: "记得你要我忘了吧" },
        { time: 98, text: "记得你叫我忘了吧" },
        { time: 103, text: "你说你会哭" },
        { time: 105, text: "不是因为在乎" },
        { time: 122, text: "朦胧的时间" },
        { time: 126, text: "我们溜了多远" },
        { time: 130, text: "冰刀划的圈" },
        { time: 133, text: "圈起了谁改变" },
        { time: 138, text: "如果再重来" },
        { time: 142, text: "会不会稍嫌狼狈" },
        { time: 147, text: "爱是不是不开口才珍贵" },
        { time: 153, text: "再给我两分钟" },
        { time: 157, text: "让我把记忆结成冰" },
        { time: 161, text: "别融化了眼泪" },
        { time: 164, text: "你妆都花了要我怎么记得" },
        { time: 169, text: "记得你叫我忘了吧" },
        { time: 173, text: "记得你叫我忘了吧" },
        { time: 178, text: "你说你会哭" },
        { time: 180, text: "不是因为在乎" },
        { time: 185, text: "再给我两分钟" },
        { time: 189, text: "让我把记忆结成冰" },
        { time: 193, text: "别融化了眼泪" },
        { time: 196, text: "你妆都花了要我怎么记得" },
        { time: 201, text: "记得你叫我忘了吧" },
        { time: 205, text: "记得你叫我忘了吧" },
        { time: 212, text: "你说你会哭" },
        { time: 214, text: "不是因为在乎" }
      ]
    }
  )
];
...
let currentPlaybackStats = null;
let lastLyricScrollTrackedAt = 0;
...
function getStatsVisitorId() {
  try {
    let visitorId = localStorage.getItem(STATS_VISITOR_STORAGE_KEY);
    if (!visitorId) {
      visitorId = `visitor_${Date.now()}_${Math.random().toString(36).slice(2)}`;
      localStorage.setItem(STATS_VISITOR_STORAGE_KEY, visitorId);
    }
    return visitorId;
  } catch (error) {
    return "visitor_unknown";
  }
}
...
function trackVisit() {
  ...
  window.clearInterval(statsPingTimer);
  statsPingTimer = window.setInterval(() => {
    sendStatsEvent("active_ping", {
...
function trackCurrentPlayback(reason = "play", options = {}) {
  ...
  sendStatsEvent("play", {
    ...
    reason,
    startedAt: currentPlaybackStats?.startedAt || new Date().toISOString(),
    currentSecond: Number((audioPlayer.currentTime || 0).toFixed(2)),
    songDuration: Number.isFinite(audioPlayer.duration) ? Number(audioPlayer.duration.toFixed(2)) : 0
  });
}

function buildPlaybackPayload(extra = {}) {
  const duration = Number.isFinite(audioPlayer.duration) ? audioPlayer.duration : 0;
  const currentSecond = Number.isFinite(audioPlayer.currentTime) ? audioPlayer.currentTime : 0;
  const startedAt = currentPlaybackStats?.startedAt || new Date().toISOString();
  const startAudioTime = Number(currentPlaybackStats?.startAudioTime || 0);
  const listenedSeconds = Math.max(0, currentSecond - startAudioTime);
  const listenedPercent = duration > 0 ? Math.min(100, Math.round((currentSecond / duration) * 10000) / 100) : 0;
  return {
    songId: currentSong?.id || "",
    songName: currentSong?.title || "",
    title: currentSong?.title || "",
    playMode: getStatsPlaybackMode(),
    mode: getStatsPlaybackMode(),
    startedAt,
    endedAt: new Date().toISOString(),
    listenedSeconds: Number(listenedSeconds.toFixed(2)),
    songDuration: Number(duration.toFixed(2)),
    listenedPercent,
    isFinished: Boolean(extra.isFinished),
    isInterrupted: Boolean(extra.isInterrupted),
    currentSecond: Number(currentSecond.toFixed(2)),
    audioField: getCurrentAudioField(),
    ...extra
  };
}
...
function startPlaybackStats() {
  if (!currentSong) return;
  currentPlaybackStats = {
    songId: currentSong.id,
    songName: currentSong.title,
    playMode: getStatsPlaybackMode(),
    startedAt: new Date().toISOString(),
    startAudioTime: Number.isFinite(audioPlayer.currentTime) ? audioPlayer.currentTime : 0
  };
}
...
function trackPause() {
  ...
  sendStatsEvent("pause", {
    ...buildPlaybackPayload({ isInterrupted: true, reason: "pause" })
  });
}
...
function trackSongSwitch(reason, fromSong) {
  ...
  sendStatsEvent("song_change", {
    ...buildPlaybackPayload({ isInterrupted: true }),
...
function trackSongOpen(song, source = "") {
  if (!song) return;
  sendStatsEvent("song_open", {
    songId: song.id,
    songName: song.title,
    title: song.title,
    mood: Array.isArray(song.mood) ? song.mood.join(",") : "",
    source
  });
}
...
function trackPageHide(reason = "page_hide") {
  sendStatsEvent("page_hide", {
    reason,
    songId: currentSong?.id || "",
    songName: currentSong?.title || "",
    title: currentSong?.title || "",
...
function trackSeek(fromSecond, toSecond) {
  if (!currentSong) return;
  sendStatsEvent("seek", {
    songId: currentSong.id,
    songName: currentSong.title,
    title: currentSong.title,
    mode: getStatsPlaybackMode(),
    fromSecond: Number((fromSecond || 0).toFixed(2)),
    toSecond: Number((toSecond || 0).toFixed(2)),
    songDuration: Number.isFinite(audioPlayer.duration) ? Number(audioPlayer.duration.toFixed(2)) : 0
  });
}

function trackModeChange(mode, detail = "") {
  sendStatsEvent("mode_change", {
    songId: currentSong?.id || "",
    songName: currentSong?.title || "",
    title: currentSong?.title || "",
    mode,
...
function seekFromProgress(input) {
  ...
  trackSeek(previousTime, audioPlayer.currentTime);
...
function setPlayMode(mode) {
  ...
  updateFloatingPlayer();
  if (previousMode !== playMode) trackModeChange(getStatsPlaybackMode(), `playMode:${playMode}`);
}
...
async function handleAudioEnded() {
  if (!currentSong) return;
  const fromSong = currentSong;
  sendStatsEvent("ended", buildPlaybackPayload({ isFinished: true, reason: "ended" }));
...
function openListenMode(options = {}) {
  ...
  trackModeChange("静听", "open-listen");
  applyPlaybackVolume();
...
function openSingMode(options = {}) {
  ...
  trackModeChange("轻唱", singAccompanyMode);
  applyPlaybackVolume();
...
async function selectSingSource(mode, force = false) {
  ...
  trackModeChange(mode === "instrumental" ? "伴奏" : "轻唱", mode);
  updateSingSourceUi();
...
[listenLyricsList?.parentElement, lyricsViewport].filter(Boolean).forEach((container) => {
  container.addEventListener("scroll", () => {
    const now = Date.now();
    if (now - lastLyricScrollTrackedAt < 3000) return;
    lastLyricScrollTrackedAt = now;
    if (!currentSong) return;
    sendStatsEvent("lyric_scroll", {
      songId: currentSong.id,
      songName: currentSong.title,
      title: currentSong.title,
      mode: getStatsPlaybackMode(),
...
document.addEventListener("visibilitychange", () => {
  if (document.hidden) {
    ...
    trackPageHide("visibility-hidden");
    return;
  }
